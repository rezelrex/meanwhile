...
.mw-head{position:sticky;top:0;z-index:50;backdrop-filter:blur(8px);background:linear-gradient(180deg,rgba(243,225,220,.95),rgba(243,225,220,.78));}
.mw-head-in{max-width:600px;margin:0 auto;padding:16px 22px 14px;display:flex;align-items:center;gap:12px;}
.mw-mark{width:42px;height:42px;border-radius:50%;display:grid;place-items:center;flex:none;color:#fff;background:radial-gradient(circle at 35% 30%,#f6c98e,var(--amber) 70%);box-shadow:0 0 16px rgba(231,167,102,.6);}
...
.mw-lights{height:7px;background:repeating-linear-gradient(90deg,transparent 0 26px,var(--amber) 26px 30px,transparent 30px 56px);filter:drop-shadow(0 0 4px rgba(231,167,102,.8));opacity:.8;}
